...
const userFixtures = [
    ...
    { fullName: "Joey Wheeler", role: "USER", status: "PENDING", city: "Bekasi", gameType: "DUEL_LINKS", gameId: "DL-DEV-003", ign: "DS Joey", guildStatus: "SOLO_PLAYER" },
    ...
    { fullName: "Tea Gardner", role: "USER", status: "REJECTED", city: "Depok", gameType: "DUEL_LINKS", gameId: "DL-DEV-005", ign: "DS Tea", guildStatus: "NEW_PLAYER" },
    ...
    { fullName: "Zane Truesdale", role: "USER", status: "PENDING", city: "Semarang", gameType: "MASTER_DUEL", gameId: "MD-DEV-014", ign: "DS Zane", guildStatus: "SOLO_PLAYER" },
