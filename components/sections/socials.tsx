...
export function Socials() {
    const { t } = useLocale();
    const socials = [
        { name: "Discord", icon: DiscordIcon, link: SOCIAL_LINKS.discord, tone: "from-[#5865F2] to-[#7b84ff]", description: t.home.socialsCards.discord },
        { name: "YouTube", icon: Youtube, link: SOCIAL_LINKS.youtube, tone: "from-[#FF0000] to-[#ff6a6a]", description: t.home.socialsCards.youtube },
        { name: "Instagram", icon: Instagram, link: SOCIAL_LINKS.instagram, tone: "from-[#F58529] via-[#DD2A7B] to-[#8134AF]", description: t.home.socialsCards.instagram },
