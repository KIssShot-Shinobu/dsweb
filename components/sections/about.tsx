        ...
        <section id="about" className="py-24 bg-[#1A1A1A] relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-[#E6E6E6]/60 max-w-2xl mx-auto text-lg leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {cards.map((card, index) => (
                        <motion.div
                            ...
                            className="p-6 rounded-2xl border border-[#3A3A3A] bg-[#2E2E2E]/50 hover:bg-[#3A3A3A]/50 hover:scale-105 transition-all duration-300 backdrop-blur-sm hover:border-[#FFC916]/30"
                        >
