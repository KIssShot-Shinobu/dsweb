...
import { Mail, Swords, Twitter, Youtube } from "lucide-react";
                ...
                <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-5 lg:gap-12">
                    <div className="lg:col-span-2">
                        ...
                        <div className="flex flex-wrap gap-3 sm:gap-4">
                            <a href="https://discord.gg/duelstandby" target="_blank" rel="noopener noreferrer" className="btn btn-outline btn-square rounded-box"><DiscordIcon className="h-5 w-5" /></a>
                            <a href="https://youtube.com/@duelstandby" target="_blank" rel="noopener noreferrer" className="btn btn-outline btn-square rounded-box"><Youtube className="h-5 w-5" /></a>
                            <a href="https://twitter.com/duelstandby" target="_blank" rel="noopener noreferrer" className="btn btn-outline btn-square rounded-box"><Twitter className="h-5 w-5" /></a>
