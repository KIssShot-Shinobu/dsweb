...
export function Footer() {
    ...
    const footerLinks = {
        community: [
            { name: t.footer.communityLinks.discord, href: SOCIAL_LINKS.discord },
            { name: t.footer.communityLinks.youtube, href: SOCIAL_LINKS.youtube },
            { name: t.footer.communityLinks.instagram, href: SOCIAL_LINKS.instagram },
        ].filter((link) => Boolean(link.href)),
        resources: [
            { name: t.footer.resourcesLinks.guide, href: "#" },
            { name: t.footer.resourcesLinks.faq, href: "#" },
            { name: t.footer.resourcesLinks.treasury, href: "/treasury" },
            { name: t.footer.resourcesLinks.support, href: "#" },
        ],
        tournaments: [
            { name: t.footer.tournamentLinks.upcoming, href: "#tournaments" },
            { name: t.footer.tournamentLinks.directory, href: "/tournaments" },
            { name: t.footer.tournamentLinks.join, href: "/register" },
        ],
        legal: [
            { name: t.footer.legalLinks.privacy, href: "/privacy" },
            { name: t.footer.legalLinks.terms, href: "/terms" },
            { name: t.footer.legalLinks.contact, href: "/contact" },
        ],
    };
        ...
        <footer className="border-t border-base-300 bg-base-100/90">
            <div className="mx-auto max-w-[1400px] px-4 py-14 sm:px-6 sm:py-16 lg:px-8">
                <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-5 lg:gap-12">
                    ...
                    <div>
                        <h4 className="mb-4 text-sm font-semibold uppercase tracking-wider text-base-content">{t.footer.communityTitle}</h4>
                    ...
                    <div>
                        <h4 className="mb-4 text-sm font-semibold uppercase tracking-wider text-base-content">{t.footer.tournamentsTitle}</h4>
                        <ul className="space-y-3">
                    ...
                    <div>
                        <h4 className="mb-4 text-sm font-semibold uppercase tracking-wider text-base-content">{t.footer.infoTitle}</h4>
                        <ul className="space-y-3">
            ...
            <div className="border-t border-base-300">
                <div className="mx-auto flex max-w-[1400px] flex-col items-center justify-between gap-4 px-4 py-6 text-center sm:px-6 md:flex-row md:text-left lg:px-8">
                    <p className="text-sm text-base-content/55">&copy; {new Date().getFullYear()} Duel Standby. {t.footer.copyright}</p>
