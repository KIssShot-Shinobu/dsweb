...
export function AnalyticsChart({ data = [], loading = false, title }: AnalyticsChartProps) {
    const { t } = useLocale();
    const chartTitle = title ?? t.dashboard.analytics.title;
            ...
            <div className="card border border-base-300 bg-base-100 shadow-md">
                <div className="card-body p-0">
                    <div className="flex items-center justify-between border-b border-base-300 px-5 py-4">
                        <span className="text-base font-semibold text-base-content">{chartTitle}</span>
                    </div>
                    <div className="p-5">
                            ...
                            <div key={index} className="flex flex-1 flex-col items-center gap-1.5">
                                <div className="flex w-full items-end gap-0.5" style={{ height: "120px" }}>
                                        <div
                                            ...
                                            title={t.dashboard.analytics.incomeTooltip(item.income)}
                                        />
                                        <div
                                            ...
                                            title={t.dashboard.analytics.expenseTooltip(item.expense)}
                                        />
                                </div>
