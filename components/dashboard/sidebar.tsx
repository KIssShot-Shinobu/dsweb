...
export function Sidebar() {
    ...
    const getInitials = (name: string) =>
        name.split(/[\s._-]+/).map((part) => part[0]).join("").toUpperCase().slice(0, 2) || "DS";
                    ...
                    <div className="border-b border-gray-200 px-3 py-3 dark:border-white/5">
                        <div className="flex items-center gap-3 rounded-xl bg-gray-100 px-3 py-2 dark:bg-white/5">
                            <div className="relative">
                                <div className="h-8 w-8 overflow-hidden rounded-lg border border-black/5 bg-ds-amber dark:border-white/8">
                                    {avatarUrl ? (
