...
export default async function MyTournamentOpenDisputePage({ params }: { params: Promise<{ id: string }> }) {
        ...
        <DashboardPageShell>
            <div className={dashboardStackCls}>
                <DashboardPageHeader
                    ...
                    title={t.dashboard.tournamentPlayerShell.nav.openDispute}
                    description={t.dashboard.myTournaments.workspace.openDisputeDescription}
                />
                <DashboardPanel
                    title={t.dashboard.tournamentPlayerShell.nav.openDispute}
                    description={t.dashboard.myTournaments.workspace.openDisputeDescription}
