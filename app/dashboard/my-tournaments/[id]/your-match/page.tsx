...
export default async function MyTournamentYourMatchPage({ params }: { params: Promise<{ id: string }> }) {
        ...
        <DashboardPageShell>
            <div className={dashboardStackCls}>
                <DashboardPageHeader
                    ...
                    title={t.dashboard.tournamentPlayerShell.nav.yourMatch}
                    description={t.dashboard.myTournaments.workspace.yourMatchDescription}
                />
                <DashboardPanel
                    title={t.dashboard.tournamentPlayerShell.nav.yourMatch}
                    description={t.dashboard.myTournaments.workspace.yourMatchDescription}
