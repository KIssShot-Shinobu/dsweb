...
export default async function MyTournamentMatchReportPage({ params }: { params: Promise<{ id: string }> }) {
        ...
        <DashboardPageShell>
            <div className={dashboardStackCls}>
                <DashboardPageHeader
                    ...
                    title={t.dashboard.tournamentPlayerShell.nav.matchReport}
                    description={t.dashboard.myTournaments.workspace.matchReportDescription}
                />
                <DashboardPanel
                    title={t.dashboard.tournamentPlayerShell.nav.matchReport}
                    description={t.dashboard.myTournaments.workspace.matchReportDescription}
