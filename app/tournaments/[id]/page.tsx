                    ...
                    <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
                        <div className="overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-[0_18px_55px_rgba(15,23,42,0.09)] dark:border-white/10 dark:bg-[#11161d] dark:shadow-[0_18px_60px_rgba(0,0,0,0.2)]">
                            ...
                            <div className="grid gap-4 p-6 md:grid-cols-4">
                                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-[#161b23]">
                                    <div className="mb-1 text-[10px] font-bold uppercase tracking-[0.24em] text-slate-400 dark:text-white/30">Jadwal Event</div>
                                ...
                                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-[#161b23]">
                                    <div className="mb-1 text-[10px] font-bold uppercase tracking-[0.24em] text-slate-400 dark:text-white/30">Biaya Masuk</div>
                                    <div className="text-sm font-semibold text-slate-700 dark:text-white/85">{tournament.entryFee > 0 ? formatCurrency(tournament.entryFee) : "Tanpa biaya"}</div>
                                </div>
                                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-[#161b23]">
                                    <div className="mb-1 text-[10px] font-bold uppercase tracking-[0.24em] text-slate-400 dark:text-white/30">Peserta Terdaftar</div>
                        ...
                        <div className="space-y-6">
                            <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_18px_55px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-[#11161d] dark:shadow-[0_18px_55px_rgba(0,0,0,0.18)]">
                                ...
                                <h2 className="mb-2 text-2xl font-black text-slate-950 dark:text-white">Amankan slot Anda</h2>
                            ...
                            <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_18px_55px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-[#11161d] dark:shadow-[0_18px_55px_rgba(0,0,0,0.18)]">
                                <div className="mb-4 text-sm font-bold uppercase tracking-[0.28em] text-amber-600 dark:text-[#FFC916]">Roster Peserta</div>
                                {tournament.participants.length === 0 ? (
                                    <p className="text-sm text-slate-600 dark:text-white/55">Belum ada peserta terdaftar. Jadilah yang pertama mengisi bracket ini.</p>
                                ) : (
